    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-games">POST api/games</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-games--id-">
                                <a href="#endpoints-GETapi-games--id-">GET api/games/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-games--id-">
                                <a href="#endpoints-PUTapi-games--id-">PUT api/games/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-games--id-">
                                <a href="#endpoints-DELETEapi-games--id-">DELETE api/games/{id}</a>
                            </li>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="genre_id"                data-endpoint="GETapi-games"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the genres table. Example: <code>17</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-games">POST api/games</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="genres[0]"                data-endpoint="POSTapi-games"
               data-component="body">
        <input type="number" style="display: none"
               name="genres[1]"                data-endpoint="POSTapi-games"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the genres table.</p>
                    ...
                    <h2 id="endpoints-GETapi-games--id-">GET api/games/{id}</h2>
...
<p>The ID of the game. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-games--id-">PUT api/games/{id}</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-games--id-"
               value="Dolores dolorum amet iste laborum eius est dolor."
               data-component="body">
    <br>
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="genres[0]"                data-endpoint="PUTapi-games--id-"
               data-component="body">
        <input type="number" style="display: none"
               name="genres[1]"                data-endpoint="PUTapi-games--id-"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the genres table.</p>
        </div>
                    ...
                    <h2 id="endpoints-DELETEapi-games--id-">DELETE api/games/{id}</h2>
